    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                ...
                <button type="button" class="btn btn-outline-danger btn-lg text-capitalize">Book Order<i class="fas fa-shopping-cart ms-2"></i></button>
            </div>
        </div>
    </nav>
    <!-- navbar end -->
            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img src="https://st3.depositphotos.com/1037238/13110/v/600/depositphotos_131102446-stock-illustration-supermarket-grocery-store.jpg" alt="First slide" class="tales">
                    </div>
                    <div class="carousel-item">
                        <img src="https://cdn.gobankingrates.com/wp-content/uploads/2020/04/grocery-delivery-iStock-1214541379.jpg" alt="second slide" class="tales">
                    </div>
                </div>
        ...
        <div class="container about p-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-3 text-center">
                    <img src="https://us.123rf.com/450wm/dolgachov/dolgachov1807/dolgachov180700084/103936796-woman-with-smartphone-buying-food-at-supermarket.jpg?ver=6" alt="grocery shop pic" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid product p-5">
            ...
            <div class="row mb-5">
                <div class="col-lg-3 px-1 py-2">
                    <div class="card">
                        <div class="text-center">
                            <img class="card-img-top img-fluid" src="https://m.media-amazon.com/images/I/51kJcHmZtPS.jpg" alt="sugar pic">
                        </div>
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <button type="button" class="btn btn-outline-dark my-2"><i class="fas fa-cart-plus me-2"></i>Add to
                                    Cart</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 px-1 py-2">
                    <div class="card">
                        <div class="text-center">
                            <img class="card-img-top img-fluid" src="https://m.media-amazon.com/images/I/71hFwEGKyZL._SL1000_.jpg" alt="dhall pic">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 px-1 py-2">
                    <div class="card">
                        <div class="text-center">
                            <img class="card-img-top img-fluid" src="https://m.media-amazon.com/images/I/81Crql2FqrL._SL1500_.jpg" alt="dark fantasy pic">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 px-1 py-2">
                    <div class="card">
                        <div class="text-center">
                            <img class="card-img-top img-fluid" src="https://m.media-amazon.com/images/I/81koTixFtqL._SL1500_.jpg" alt="soap pic">
                        </div>
                        <div class="card-body">
            ...
            <div class="row mb-5">
                <div class="col-lg-3 px-1 py-2">
                    <div class="card">
                        <div class="text-center">
                            <img class="card-img-top img-fluid" src="https://m.media-amazon.com/images/I/61DZ+zx2EKL._SX679_.jpg" alt="horlicks pic">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 px-1 py-2">
                    <div class="card">
                        <div class="text-center">
                            <img class="card-img-top img-fluid" src="https://m.media-amazon.com/images/I/518GEoZtbhL.jpg" alt="tata salt pic">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 px-1 py-2">
                    <div class="card">
                        <div class="text-center">
                            <img class="card-img-top img-fluid" src="https://m.media-amazon.com/images/I/71EesMJmIqL._SL1500_.jpg" alt="chocos pic">
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 px-1 py-2">
                    <div class="card">
                        <div class="text-center">
                            <img class="card-img-top img-fluid" src="https://m.media-amazon.com/images/I/61uIs+np2TL._SL1500_.jpg" alt="biscuit pic">
                        </div>
                        <div class="card-body">
            ...
            <div class="text-center">
                <button type="button" class="btn btn-danger btn-lg my-1">Click here for more items<i class="fas fa-arrow-right ms-3"></i></button>
            </div>
        </div>
    </section>
    <!-- product end -->
                ...
                <div class="col-lg-6">
                    <form action="index.php" method="post" onsubmit="return validate()">
                        <div class="mb-3 form">
                            ...
                            <input type="text" class="form-control" name="name" id="name" aria-describedby="msg1" placeholder="Enter ur name">
                        ...
                        <div class="mb-3 form">
                            ...
                            <input type="number" class="form-control" name="number" id="number" aria-describedby="msg2" placeholder="Enter ur number">
                        ...
                        <div class="mb-3 form">
                            ...
                            <input type="email" class="form-control" name="email" id="email" aria-describedby="msg3" placeholder="Enter ur email-id">
